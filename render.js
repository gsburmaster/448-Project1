...
startScreen is unfinished, as I didn't even get close to img_rotate. 
...
let img_submitwidth = 81;
let img_submitheight = 21;

let img_fire = new Image();
img_fire.src = 'Images/fire.png';
let img_firewidth = 50;
let img_fireheight = 20;
...
let img_rotatewidth = 83;
let img_rotateheight = 19;
...
//this is the gameplay render function. it is the both grids showing,"img_fire" screen. 
...
function gameplay(data) {
        ...
        context.drawImage(img_fire,canvas.width*3/4-img_firewidth*3/2,canvas.height-canvas.height/6,img_firewidth*3,img_fireheight*3);
...
function startScreen(player1,player2,data) {
   ...
   context.drawImage(img_gameLogo, (canvas.width / 2) - (1.5 * logowidth), 0, logowidth * 3, logoheight * 3);
    ...
    context.drawImage(img_rotate, canvas.width - (canvas.width / 4) - (.5 * img_rotatewidth), canvas.height/2 - img_rotateheight/2, img_rotatewidth , img_rotateheight );
    
    
    context.drawImage(img_submit, canvas.width/2  -img_submitwidth, canvas.height - canvas.height/8 - img_submitheight/2, img_submitwidth *2, img_submitheight *2);
